...
<head>
    ...
    <meta name="description" content="zeng - Therapy & Counseling Psychologist WordPress Theme">
                            ...
                            <div class="offset-xxl-4 col-xxl-7 offset-xl-4 col-xl-7">
                                <div class="header-sidebar style-horizontal bs-light-mode">
                                    <div class="box ">
                                        ...
                                        <div class="avatar">
                                            <img src="<?php echo esc_url($website_info['custom_avatar']); ?>" width="68"
                                        ...
                                        <div class="info">
                                            ...
                                            <h6 class="font-4 mb_4"><?php echo esc_html($website_info['full_name']); ?>
                                            </h6>
                                            <?php else: ?>
                                            ...
                                            <div
                                                class="text-label text-uppercase fw-6 text_primary-color font-3  letter-spacing-1">
                                    ...
                                    <a class="menu-button show-menu-mobile  d-sm-none link-no-action"
                                        data-target="#menu-1" href="#"><i class="icon-CirclesFour"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="offset-xxl-4 col-xxl-7 offset-xl-4 col-xl-7 ">
                        ...
                        <div class="main-content section-onepage">
                            ...
                            <div class="user-bar text-center">
                                ...
                                <div class="box-author mb_12">
                                    <div class="img-style mb_16">
                                        ...
                                        <img decoding="async" loading="lazy"
                                            src="<?php echo esc_url($website_info['custom_avatar']); ?>" width="314"
                                            height="314" alt="feature post">
                                        <?php else: ?>
                                        <img src="<?php echo  THEMESFLAT_LINK . '/images/avatar-thumbnail.png'; ?>"
                                            alt="avatar">
                                        <?php endif; ?>
                                    </div>
                                    <div class="info">
                                        <?php if ($website_info['full_name']): ?>
                                        <div class="name font-2 text_white mb_8">
                                            <?php echo esc_html($website_info['full_name']); ?></div>
                                        <?php else: ?>
                                        ...
                                        <div
                                            ...
                                            <?php echo esc_html($website_info['job_title']); ?></div>
                                        <?php else: ?>
                                        <div
                                            class="text-label text-uppercase fw-6 text_primary-color font-3 mb_16 letter-spacing-1">
                                            <?php echo _e('AI Developer', 'zeng'); ?></div>
                                        <?php endif; ?>
                                        ...
                                        <p class="text-caption-2 text_secondary-color font-3">
                                            <?php echo esc_html($website_info['address']); ?></p>
                                        <?php else: ?>
                                        <p class="text-caption-2 text_secondary-color font-3">
                                            <?php echo _e('Based in San Francisco, CA', 'zeng'); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <a href="<?php echo esc_attr($website_info['cv_link']); ?>"
                                    class="tf-btn btn-w-full style-border mb_20">
                                    <span class="bg_btn"></span>
                                    <span class="title"><i
                                            class="icon-ReadCvLogo"></i><?php echo _e('View My CV', 'zeng'); ?></span>
                                    <span class="effect-shine"></span>
                                </a>
                                <?php endif; ?>

                                <?php if ($website_info['contact_link']): ?>
                                <a href="<?php echo esc_attr($website_info['contact_link']); ?>"
                                    class="tf-btn style-1 animate-hover-btn btn-w-full">
                                    <i
                                        class="icon-EnvelopeSimple"></i><span><?php echo _e('Contact Me', 'zeng'); ?></span>
                                </a>
                                <?php endif; ?>
