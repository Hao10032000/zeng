...
$wp_customize->add_control( 'h1_size', array(
    ...
    'priority'    => 2,
    'section'     => 'section_typo_heading',
    'label'       => esc_html__('H1 font size (px)', 'zeng'),
    'input_attrs' => array(
        'min'   => 10,
        'max'   => 60,
        'step'  => 1,
...
$wp_customize->add_control( 'h2_size', array(
    ...
    'priority'    => 3,
    'section'     => 'section_typo_heading',
    'label'       => esc_html__('H2 font size (px)', 'zeng'),
    'input_attrs' => array(
        'min'   => 10,
        'max'   => 60,
        'step'  => 1,
...
$wp_customize->add_control( 'h3_size', array(
    ...
    'priority'    => 4,
    'section'     => 'section_typo_heading',
    'label'       => esc_html__('H3 font size (px)', 'zeng'),
    'input_attrs' => array(
        'min'   => 10,
        'max'   => 60,
        'step'  => 1,
...
$wp_customize->add_control( 'h4_size', array(
    ...
    'priority'    => 5,
    'section'     => 'section_typo_heading',
    'label'       => esc_html__('H4 font size (px)', 'zeng'),
    'input_attrs' => array(
        'min'   => 10,
        'max'   => 60,
        'step'  => 1,
...
$wp_customize->add_control( 'h5_size', array(
    ...
    'priority'    => 6,
    'section'     => 'section_typo_heading',
    'label'       => esc_html__('H5 font size (px)', 'zeng'),
    'input_attrs' => array(
        'min'   => 10,
        'max'   => 60,
        'step'  => 1,
...
$wp_customize->add_control( 'h6_size', array(
    ...
    'priority'    => 7,
    'section'     => 'section_typo_heading',
    'label'       => esc_html__('H6 font size (px)', 'zeng'),
    'input_attrs' => array(
        'min'   => 10,
        'max'   => 60,
        'step'  => 1,
